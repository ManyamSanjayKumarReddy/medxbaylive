        ...
        const fetchDropdownData = async () => {
            try {
                const [countriesRes, statesRes, citiesRes, specialitiesRes, conditionsRes, languagesRes, hospitalsRes] = await Promise.all([
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/countries`),
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/states`),
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/cities`),
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/specialities`),
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/conditions`),
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/languages`),
                    axios.get(`${process.env.REACT_APP_BASE_URL}/auth/hospitals`)
                ]);
