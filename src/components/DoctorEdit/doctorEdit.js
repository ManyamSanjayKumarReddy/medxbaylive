...
<path d="M0.916748 25.7087C0.916748 28.1878 2.81258 30.0837 5.29175 30.0837H25.7084C28.1876 30.0837 30.0834 28.1878 30.0834 25.7087V14.042H0.916748V25.7087ZM25.7084 3.83366H22.7917V2.37533C22.7917 1.50033 22.2084 0.916992 21.3334 0.916992C20.4584 0.916992 19.8751 1.50033 19.8751 2.37533V3.83366H11.1251V2.37533C11.1251 1.50033 10.5417 0.916992 9.66675 0.916992C8.79175 0.916992 8.20841 1.50033 8.20841 2.37533V3.83366H5.29175C2.81258 3.83366 0.916748 5.72949 0.916748 8.20866V11.1253H30.0834V8.20866C30.0834 5.72949 28.1876 3.83366 25.7084 3.83366Z" fill="#0167FF"/>
          ...
          <div className='edit-profile-date'>{doctor ? doctor.dateOfBirth : 'Loading...'}</div>
          <div className='date-edit-vector'></div>
          <div className='doctor-edit-location'>
          <svg width="21" height="31" viewBox="0 0 21 31" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.5001 14.7712C9.53315 14.7712 8.60581 14.387 7.92209 13.7033C7.23836 13.0196 6.85425 12.0923 6.85425 11.1253C6.85425 10.1584 7.23836 9.23106 7.92209 8.54733C8.60581 7.86361 9.53315 7.47949 10.5001 7.47949C11.467 7.47949 12.3943 7.86361 13.0781 8.54733C13.7618 9.23106 14.1459 10.1584 14.1459 11.1253C14.1459 11.6041 14.0516 12.0782 13.8684 12.5205C13.6852 12.9629 13.4166 13.3648 13.0781 13.7033C12.7395 14.0419 12.3376 14.3104 11.8953 14.4936C11.4529 14.6769 10.9789 14.7712 10.5001 14.7712ZM10.5001 0.916992C7.79266 0.916992 5.19613 1.99251 3.2817 3.90694C1.36727 5.82138 0.291748 8.41791 0.291748 11.1253C0.291748 18.7816 10.5001 30.0837 10.5001 30.0837C10.5001 30.0837 20.7084 18.7816 20.7084 11.1253C20.7084 8.41791 19.6329 5.82138 17.7185 3.90694C15.804 1.99251 13.2075 0.916992 10.5001 0.916992Z" fill="#0167FF"/>
</svg>
          </div>
    ...
    <div className='speciality-container'>
      ...
      <div className='edit-profile-Heart-Specialist'>{doctor ? doctor.speciality : 'Loading...'}</div>
    </div>
  ...
  {doctor ? (
    ...
    <div className='video-consult-container'>
      ...
      <div className='video-consult-text'>{doctor ? doctor.consultation : 'Loading...'}</div>
